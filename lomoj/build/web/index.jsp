        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp?p=formProduto">Produtos </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Lojas</a>
                    </li>
                      <li class="nav-item">
                          <a class="nav-link" href="index.jsp?p=reportCliente">Listar Cliente</a>
                    </li>
                      <li class="nav-item">
                        <a class="nav-link" href="index.jsp?p=reportProduto">Listar Produto</a>
                    </li>
                </ul>
